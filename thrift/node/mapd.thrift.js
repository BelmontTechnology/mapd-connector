          ...
          for (var _i435 = 0; _i435 < _size430; ++_i435)
          {
            ...
            for (var _i443 = 0; _i443 < _size438; ++_i443)
            {
              ...
              for (var _i451 = 0; _i451 < _size446; ++_i451)
              {
                ...
                {
                  var elem460 = null;
                  elem460 = new ttypes.TRenderDatum();
                  elem460.read(input);
                  val453.push(elem460);
                }
                input.readListEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem486 = null;
          elem486 = new ttypes.TColumnType();
          elem486.read(input);
